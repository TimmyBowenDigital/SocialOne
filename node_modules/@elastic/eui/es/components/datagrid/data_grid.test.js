...
function extractGridData(datagrid) {
  var rows = [];
  var headerCells = findTestSubject(datagrid, 'dataGridHeaderCell', '|=');
  var headerRow = [];
  headerCells.forEach(function (cell) {
    return headerRow.push(cell.find('[className="euiDataGridHeaderCell__content"]').text());
  });
  rows.push(headerRow);
  var gridRows = findTestSubject(datagrid, 'dataGridRow');
  gridRows.forEach(function (row) {
    var rowContent = [];
    var cells = findTestSubject(row, 'dataGridRowCell');
...
function extractColumnWidths(datagrid) {
  return findTestSubject(datagrid, 'dataGridHeaderCell', '|=').reduce(function (widths, cell) {
...
function openColumnSorterSelection(datagrid) {
...
function closeColumnSorterSelection(datagrid) {
  var columnSelectionPopover = datagrid.find('EuiPopover[data-test-subj="dataGridColumnSortingPopoverColumnSelection"]'); // popover will go away if all of the columns are selected
...
function getColumnSortDirection(datagrid, columnId) {
  ...
  if (columnSorter.length === 0) {
    ...
    openColumnSorterSelection(datagrid); // find button to enable this column and click it
    ...
    closeColumnSorterSelection(datagrid); // find the column sorter

    var columnSelectionPopover = datagrid.find('EuiPopover[data-test-subj="dataGridColumnSortingPopover"]');
  ...
  var activeSort = columnSorter.find('button[className*="euiButtonGroup__button--selected"]').closest('EuiToggle').find('input[className*="euiButtonToggle__input"]');
  var sortDirection = activeSort.props()['data-test-subj'].match(/(?<direction>[^-]+)$/).groups.direction;
  return [columnSorter, sortDirection];
}

function openColumnSorter(datagrid) {
...
function closeColumnSorter(datagrid) {
  var popover = datagrid.find('EuiPopover[data-test-subj="dataGridColumnSortingPopover"]');
  expect(popover).euiPopoverToBeOpen();
  var popoverButton = popover.find('div[className="euiPopover__anchor"]').find('[onClick]').first(); // @ts-ignore-next-line
...
function sortByColumn(datagrid, columnId, direction) {
  ...
  if (currentSortDirection !== direction) {
    var sortButton = columnSorter.find("input[data-test-subj=\"euiDataGridColumnSorting-sortColumn-".concat(columnId, "-").concat(direction, "\"]"));
...
function openColumnSelector(datagrid) {
...
function closeColumnSelector(datagrid) {
  var popover = datagrid.find('EuiPopover[data-test-subj="dataGridColumnSelectorPopover"]');
  expect(popover).euiPopoverToBeOpen();
  var popoverButton = popover.find('div[className="euiPopover__anchor"]').find('[onClick]').first(); // @ts-ignore-next-line
...
function setColumnVisibility(datagrid, columnId, isVisible) {
  var popover = openColumnSelector(datagrid); // toggle column's visibility switch
...
describe('EuiDataGrid', function () {
  describe('rendering', function () {
    it('renders with common and div attributes', function () {
      var component = render(React.createElement(EuiDataGrid, _extends({}, requiredProps, {
        columns: [{
          id: 'A'
        }, {
          id: 'B'
    ...
    it('renders custom column headers', function () {
      var component = render(React.createElement(EuiDataGrid, _extends({}, requiredProps, {
        columns: [{
          ...
          id: 'B',
          display: React.createElement("div", null, "More Elements")
        }],
        columnVisibility: {
          visibleColumns: ['A', 'B'],
          setVisibleColumns: function setVisibleColumns() {}
    ...
    it('renders and applies custom props', function () {
      var component = mount(React.createElement(EuiDataGrid, _extends({}, requiredProps, {
        columns: [{
          id: 'A'
        }, {
          id: 'B'
    ...
    it('renders additional toolbar controls', function () {
      var component = render(React.createElement(EuiDataGrid, _extends({}, requiredProps, {
        ...
        toolbarVisibility: {
          additionalControls: React.createElement("button", null, "Button")
        }
      })));
      expect(component).toMatchSnapshot();
    });
    it('can hide the toolbar', function () {
      ...
      expect(findTestSubject(component, 'dataGridControls').length).toBe(0); // Check for false / true and unset values
      ...
      expect(findTestSubject(component, 'dataGridFullScrenButton').length).toBe(0); // sort selector

      expect(findTestSubject(component, 'dataGridColumnSortingButton').length).toBe(0); // style selector

      expect(findTestSubject(component, 'dataGridStyleSelectorButton').length).toBe(1); // column selector

      expect(findTestSubject(component, 'dataGridColumnSelectorButton').length).toBe(1);
    });
  ...
  describe('cell rendering', function () {
    it('supports hooks', function () {
      var component = mount(React.createElement(EuiDataGrid, {
        "aria-label": "test",
        columns: [{
          id: 'Column 1'
        }, {
        ...
        renderCellValue: function renderCellValue(_ref11) {
          ...
          var _useState = useState("Hello, Row ".concat(rowIndex, "-").concat(columnId, "!")),
  ...
  describe('pagination', function () {
    it('renders', function () {
      ...
      expect(takeMountedSnapshot(component.find('EuiTablePagination'))).toMatchSnapshot();
    });
  ...
  describe('column sizing', function () {
    it('uses a columns initialWidth', function () {
      var component = mount(React.createElement(EuiDataGrid, {
    ...
    describe('resizing', function () {
      ...
      it('is prevented by isResizable:false', function () {
        var component = mount(React.createElement(EuiDataGrid, {
          "aria-labelledby": "#test",
          columns: [{
            id: 'Column 1',
        ...
        expect(component.find('EuiDataGridColumnResizer[columnId="Column 1"]').length).toBe(0);
        expect(component.find('EuiDataGridColumnResizer[columnId="Column 2"]').length).toBe(1);
      });
  ...
  describe('updating column definitions', function () {
    it('renders the new set', function () {
      ...
      expect(extractGridData(component)).toEqual([['A', 'B'], ['0-A', '0-B'], ['1-A', '1-B']]);
      component.setProps({
        columns: [{
          id: 'A'
        }, {
      ...
      expect(extractGridData(component)).toEqual([['A', 'C'], ['0-A', '0-C'], ['1-A', '1-C']]);
    });
    it('"Hide fields" updates', function () {
      var component = mount(React.createElement(EuiDataGrid, {
        "aria-labelledby": "#test",
        columns: [{
          id: 'A'
      ...
      var popover = openColumnSelector(component);
      expect(popover.find('.euiDataGridColumnSelector__item').map(function (item) {
        return item.text();
      })).toEqual(['A', 'B']);
      closeColumnSelector(component); // update columns
    ...
    it('"Sort fields" updates', function () {
      var component = mount(React.createElement(EuiDataGrid, {
        "aria-labelledby": "#test",
        columns: [{
          id: 'A'
      ...
      var popover = openColumnSorterSelection(component);
      expect(popover.find('.euiDataGridColumnSorting__field').map(function (item) {
        return item.text();
      })).toEqual(['A', 'B']);
      closeColumnSorterSelection(component);
      closeColumnSorter(component); // update columns
  ...
  describe('keyboard controls', function () {
    it('supports simple arrow navigation', function () {
      ...
      var component = mount(React.createElement(EuiDataGrid, _extends({}, requiredProps, {
        ...
        rowCount: 8,
        renderCellValue: function renderCellValue(_ref26) {
          var rowIndex = _ref26.rowIndex,
              columnId = _ref26.columnId;
          return "".concat(rowIndex, ", ").concat(columnId);
        },
        pagination: pagination
      })));
    ...
    it.skip('supports arrow navigation through grids with different interactive cells', function () {
      var component = mount(React.createElement(EuiDataGrid, _extends({}, requiredProps, {
        ...
        rowCount: 2,
        renderCellValue: function renderCellValue(_ref28) {
          var rowIndex = _ref28.rowIndex,
              columnId = _ref28.columnId;
          ...
          if (columnId === 'B') {
            return React.createElement("button", null, rowIndex, ", B");
          }

          if (columnId === 'C') {
            return React.createElement(React.Fragment, null, React.createElement("button", null, rowIndex), ", ", React.createElement("button", null, "C"));
          }

          if (columnId === 'D') {
            return React.createElement("div", null, rowIndex, ", ", React.createElement("button", null, "D"));
          }
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              component = mount(React.createElement(EuiDataGrid, _extends({}, requiredProps, {
                columns: [{
                  id: 'A'
                }, {
                  id: 'B'
                ...
                rowCount: 3,
                renderCellValue: function renderCellValue(_ref30) {
                  var rowIndex = _ref30.rowIndex,
                      columnId = _ref30.columnId;
                  return React.createElement(React.Fragment, null, React.createElement("button", null, rowIndex), ", ", React.createElement("button", null, columnId));
                }
              })));
              /**
               * Make sure we start from a happy state
