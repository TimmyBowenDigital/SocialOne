...
describe('EuiDualRange', function () {
  test('is rendered', function () {
    var component = render(React.createElement(EuiDualRange, _extends({
      name: "name",
      id: "id",
      value: ['1', '8']
    }, props, requiredProps)));
  ...
  describe('props', function () {
    test('disabled should render', function () {
      var component = render(React.createElement(EuiDualRange, _extends({}, props, {
        value: ['1', '8'],
        disabled: true
      })));
      expect(component).toMatchSnapshot();
    ...
    test('levels should render', function () {
      var component = render(React.createElement(EuiDualRange, {
        levels: [{
          min: 0,
          max: 20,
          color: 'danger'
