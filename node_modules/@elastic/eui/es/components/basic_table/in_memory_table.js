...
import { Comparators } from '../../services/sort'; // @ts-ignore
...
EuiInMemoryTable.propTypes = {
  ...
  search: PropTypes.oneOfType([PropTypes.bool.isRequired, PropTypes.shape({
    ...
    /**
       ...
       */
    box: PropTypes.shape({
      schema: PropTypes.oneOfType([PropTypes.bool.isRequired, PropTypes.shape({
    ...
    filters: PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.shape({
      ...
      filterWith: PropTypes.oneOfType([PropTypes.func.isRequired, PropTypes.oneOf(["prefix", "includes"])]),
