...
function (_Component) {
  ...
  function EuiNavDrawer(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "expandFlyout", function (links, title, item) {
      var content = links;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "modifyChildren", function (children) {
