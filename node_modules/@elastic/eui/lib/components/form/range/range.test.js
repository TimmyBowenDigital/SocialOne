...
describe('EuiRange', function () {
  test('is rendered', function () {
    var component = (0, _enzyme.render)(_react.default.createElement(_range.EuiRange, _extends({
      name: "name",
      id: "id",
  ...
  describe('props', function () {
    test('disabled should render', function () {
      var component = (0, _enzyme.render)(_react.default.createElement(_range.EuiRange, _extends({}, props, {
        disabled: true
      })));
      expect(component).toMatchSnapshot();
    });
    ...
    test('levels should render', function () {
      var component = (0, _enzyme.render)(_react.default.createElement(_range.EuiRange, {
        levels: [{
          min: 0,
          max: 20,
          color: 'danger'
