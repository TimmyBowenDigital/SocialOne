...
var EuiDataGridColumnSortingDraggable = function EuiDataGridColumnSortingDraggable(_ref) {
  ...
  var textSortAsc = schema.hasOwnProperty(id) && schema[id].columnType != null ? (0, _data_grid_schema.getDetailsForSchema)(schemaDetectors, schema[id].columnType).sortTextAsc : _react.default.createElement(_i18n.EuiI18n, {
    token: "euiColumnSortingDraggable.defaultSortAsc",
    default: "A-Z"
  });
  var textSortDesc = schema.hasOwnProperty(id) && schema[id].columnType != null ? (0, _data_grid_schema.getDetailsForSchema)(schemaDetectors, schema[id].columnType).sortTextDesc : _react.default.createElement(_i18n.EuiI18n, {
...
EuiDataGridColumnSortingDraggable.propTypes = {
  ...
  defaultSchemaColor: _propTypes.default.string.isRequired
};
