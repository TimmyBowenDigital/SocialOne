...
var EuiDataGridBody = function EuiDataGridBody(props) {
  ...
  var rows = (0, _react.useMemo)(function () {
    return visibleRowIndices.map(function (rowIndex, i) {
      ...
      return _react.default.createElement(_data_grid_data_row.EuiDataGridDataRow, {
        ...
        focusedCellPositionInTheRow: i === focusedCell[1] ? focusedCell[0] : null,
  ...
  }, [visibleRowIndices, rowMap, columns, schema, mergedPopoverContents, columnWidths, defaultColumnWidth, focusedCell, onCellFocus, renderCellValue, interactiveCellId]);
