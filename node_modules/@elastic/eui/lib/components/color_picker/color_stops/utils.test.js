...
describe('isInvalid', function () {
  test('Should not mark valid colorStops as invalid', function () {
    expect((0, _utils.isInvalid)(colorStops)).toBe(false);
  });
  test('Should mark colorStops missing color as invalid', function () {
    ...
    expect((0, _utils.isInvalid)(colorStops)).toBe(true);
  });
...
describe('addStop', function () {
  test('Should add stop when there is only a single stop', function () {
    ...
    expect((0, _utils.addStop)(colorStops, '#FF0000', 100)).toEqual([{
      stop: 0,
      color: '#FF0000'
    }, {
      stop: 1,
...
describe('addDefinedStop', function () {
  ...
  test('Should add stop', function () {
    expect((0, _utils.addDefinedStop)(colorStops, 1)).toEqual([{
      stop: 0,
      color: '#FF0000'
    }, {
      stop: 1,
  ...
  test('Should add stop with a specified color', function () {
    expect((0, _utils.addDefinedStop)(colorStops, 1, '#FFFFFF')).toEqual([{
      stop: 0,
      color: '#FF0000'
    }, {
      stop: 1,
...
describe('removeStop', function () {
  test('Should not remove only stop', function () {
    ...
    expect((0, _utils.removeStop)(colorStops, 0)).toEqual(colorStops);
  });
  test('Should remove stop at index', function () {
    ...
    expect((0, _utils.removeStop)(colorStops, 1)).toEqual([{
      stop: 0,
      color: '#FF0000'
    }, {
      stop: 35,
