...
var _useDependentState3 = require("./useDependentState");
...
describe('useDependentState', function () {
  it('sets the base state', function () {
    ...
    function Foo() {
      var _useDependentState = (0, _useDependentState3.useDependentState)(doubler, [sourceValue]),
    ...
    var component = (0, _enzyme.mount)(_react.default.createElement(Foo, null));
